...
const GestionUtilisateurs = () => {
    ...
    useEffect(()=>{
        if(city!=null){
            setClientFilters((prev)=>{return {...prev,city:city}})
            setDriverFilters((prev)=>{return {...prev,city:city}})
        }
    },[city])
    ...
    const handleGetDrivers=()=>{
        ...
        if(driverFilters.driver_type==="")
            driverTmp={...driverFilters,driver_type:null}
    ...
    const handleDelete=async(id,role)=>{
        ...
        if(response.ok){
            if(role==="Client")
                ...
                dispatch(getDrivers(driverFilters))
        }
    }
        ...
        <div className='clients'>
            ...
            <div className='filters'>
                <div>
                    ...
                    <select name='sortByOrders' value={clientFilters.sortByOrders} onChange={(e)=>handleInputChange(e,setClientFilters)}>
                ...
                <div>
                    <button onClick={handleGetClients}><SearchSharp/></button>
                </div>
            </div>
        ...
        <div className='drivers'>
            ...
            <div className='filters'>
                <div>
                    ...
                    <select name='sortByMissions' value={driverFilters.sortByMissions} onChange={(e)=>handleInputChange(e,setDriverFilters)}>
                        <option value="">--par defaut--</option>
                        <option value="DESC">Desc</option>
                        <option value="ASC">Asc</option>
                    </select>
                ...
                <div>
                    <label>Type : </label>
                    <select name='driver_type' value={driverFilters.driver_type} onChange={(e)=>handleInputChange(e,setDriverFilters)}>
                ...
                <div>
                    ...
                    <select name='is_available' value={driverFilters.is_available} onChange={(e)=>handleInputChange(e,setDriverFilters)}>
                        <option value="">--par defaut--</option>
                ...
                <div>
                    <button onClick={handleGetDrivers}><SearchSharp/></button>
                </div>
            </div>
            <div className='tables'>
            <table className="styled-table">
